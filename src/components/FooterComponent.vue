<template>
  <div>
    <footer class="footer bg-secondary pt-5">
      <div class="container pt-lg-4 pb-4">
        ...
        <div class="row mb-5 pb-md-3 pb-lg-4">
          <div class="col-lg-6 mb-lg-0 mb-4">
            ...
            >
              <div class="mb-sm-0 mb-4 px-2">
                <a class="d-inline-block mb-4" href="real-estate-home-v1.html"
                  ><img src="/logo/sorena.png" width="40" alt="logo"
                /></a>
                <ul class="nav flex-column mb-sm-4 mb-2">
                  <li class="nav-item mb-2">
                    <a
                      class="nav-link p-0 fw-normal"
                  ...
                  <li class="nav-item">
                    <a class="nav-link p-0 fw-normal" href="tel:4065550120"
                      ><i
                        class="fi-device-mobile mt-n1 me-2 align-middle opacity-70"
                      ></i
                      >(406) 555-0120</a
                    >
                  </li>
              ...
              <div class="mb-sm-0 mb-4 px-2">
                ...
                <ul class="nav flex-column">
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">خرید یک ملک</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">فروش یک ملک</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">اجاره یک ملک</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">محاسبه یک ملک</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#"
                      >پیشنهادهای ویژه</a
                    >
                  </li>
                  <li class="nav-item mb-2">
              ...
              <div class="px-2">
                ...
                <ul class="nav flex-column">
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">درباره ما</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">نمایندگان ما</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">مشاوره رایگان</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">تماس با ما</a>
                  </li>
                  <li class="nav-item mb-2">
                    <a class="nav-link p-0 fw-normal" href="#">اخبار</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-xl-5 col-lg-6 offset-xl-1">
            ...
            <article class="d-flex align-items-start" style="max-width: 640px">
              ...
              /></a>
              <div>
                <h6 class="mb-1 fs-sm fw-normal text-uppercase text-primary">
                  نکات و ترفندها
                </h6>
                <h5 class="mb-2 fs-base">
                  <a class="nav-link" href="real-estate-blog-single.html"
                    >راهنمای ما برای جستجوی آپارتمان هوشمند</a
                  >
                </h5>
                <p class="mb-2 fs-sm">
                ...
                <a
                  ...
                  href="#"
                  ><i
                    class="fi-calendar mt-n1 me-1 fs-sm align-middle opacity-70"
                  ></i
                  >24 خرداد</a
                ><a
                  class="nav-link nav-link-muted d-inline-block me-3 p-0 fs-xs fw-normal"
                  href="#"
                  ><i
                    class="fi-chat-circle mt-n1 me-1 fs-sm align-middle opacity-70"
                  ></i
                  >2 کامنت</a
                >
              </div>
            ...
            <article class="d-flex align-items-start" style="max-width: 640px">
              ...
              <div>
                ...
                <h5 class="mb-2 fs-base">
                  <a class="nav-link" href="real-estate-blog-single.html"
                    >10 روش برتر برای تجدید فضای خود</a
                  >
                </h5>
                <p class="mb-2 fs-sm">
                  لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم
        ...
        <div class="bg-dark rounded-3">
          ...
          >
            <img
              class="flex-shrink-0 mt-md-n5 me-md-5"
              src="/mobile.svg"
              width="240"
              alt="اپلیکیشن"
            />
            ...
            >
              <div class="me-md-5">
                ...
                <p class="mb-lg-0 text-light">
                  همه چیزهایی را که برای خرید ، فروش اجاره ملک نیاز دارید در
                  برنامه Finder جدید ما پیدا کنید!
                </p>
              </div>
              <div class="flex-shrink-0">
                <a
                  class="btn-market mx-2 ms-sm-0 ms-sm-4 mb-3"
                  href="#"
                  role="button"
                  ><svg
                ...
                ><a class="btn-market mb-3" href="#" role="button"
                  ...
                  >
                    ...
                    <g opacity=".2">
                      <mask id="A" fill="#fff"><use xlink:href="#E" /></mask>
                    ...
                    <g opacity=".2">
                      <mask id="B" fill="#fff"><use xlink:href="#F" /></mask>
                    ...
                    <g opacity=".2">
                      <mask id="C" fill="#fff"><use xlink:href="#G" /></mask>
    ...
    <!-- Back to top button--><a class="btn-scroll-top" href="#top" data-scroll
      ><span class="btn-scroll-top-tooltip text-muted fs-sm ms-2">بالا</span
