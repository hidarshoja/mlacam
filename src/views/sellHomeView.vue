    ...
    <div class="container-fluid mt-5 pt-5 p-0">
      <div class="row g-0 mt-n3">
                ...
                <div class="pb-4 mb-2">
                  ...
                  >
                    ...
                    >
                      ...
                      <label
                        class="form-check-label fs-sm"
                        :for="facilitiesType.id"
                        >{{ facilitiesType.label }}
                      </label>
                    </div>
                  </div>
                </div>
                <div class="pb-4 mb-2">
                  ...
                  >
                    <input
                      ...
                      :value="animal.id"
                    />
                    <label class="form-check-label fs-sm" :for="animal.id"
                      >{{ animal.label }}
                    </label>
                  </div>
                </div>
        ...
        >
          ...
          >
            <h1 class="h4 mb-sm-0">لیست املاک برای فروش</h1>
            <a
  ...
  methods: {
    fetchData() {
      axios
        ...
        .then((res) => {
          console.log("sellHomeComponent", res.data);
          // this.items = res.data
        })
        .catch((error) => {
          console.error(error);
    ...
    applyFilters() {
      ...
      axios
        .post("https://jsonplaceholder.typicode.com/posts", filtersDataSell)
        .then((res) => {
