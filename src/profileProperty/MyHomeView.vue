<template>
      ...
      <div class="container pt-5 pb-lg-4 mt-5 mb-sm-2">
        ...
        <div class="row">
          ...
          <aside class="col-lg-4 col-md-5 pe-xl-4 mb-5">
            ...
            <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
              ...
              <div class="collapse d-md-block mt-3" id="account-nav">
                <div class="card-nav">
                    <a class="card-nav-link" href="/realstate/profileUsers"
                ...
                ><a class="card-nav-link active" href="/realstate/myHome"
                  ><i class="fi-home opacity-60 me-2 "></i>لیست املاک من</a>
                  <a
                    class="card-nav-link "
                    href="/realstate/liveHomeAdmin"
                  ...
                  <a
                    class="card-nav-link"
                    href="/notification"
                    ><i class="fi-bell opacity-60 me-2"></i>لیست تراکنش های مالی</a
                  >
          ...
          <div class="col-lg-8 col-md-7 mb-5">
            ...
            <p class="pt-1 mb-4">
              در اینجا می توانید پیشنهادات ملک خود را مشاهده کرده و به راحتی آنها
              را ویرایش کنید.
            </p>
            <!-- start tabs -->
                   <tabsMyPropertyComponent />
            <!-- end tabs-->
  ...
  <script>
      import tabsMyPropertyComponent from '@/components/tabsMyPropertyComponent.vue';
